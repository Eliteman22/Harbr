...
class LoginHomeViewController: UIViewController {
    ...
    @IBOutlet var eventsAroundYou: UILabel!
    ...
    override func viewDidLoad() {
        ...
        query.findObjectsInBackgroundWithBlock({
            ...
            if error == nil {
                ...
                var postAmount = self.count
                var stringToPost = "\(postAmount) events around you"
                self.eventsAroundYou.text = stringToPost
            }
        })
                ...
                if user.isNew {
                    ...
                    request.startWithCompletionHandler {
                        ...
                        if error != nil {
                            ...
                            self.performSegueWithIdentifier("straightLogin", sender: self)
                        }
                    }
